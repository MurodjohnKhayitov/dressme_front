...
import { arrowBottomBlack, arrowBottomRight, blog, booking, brush, bucket, business, businessBlack, catalog, close, clothing, contact, dashboard, dollar, eng, female, heart, help, helpBlack, location, logo, logoo, male, map, menu, search, shop, topBrands, user, voice, winter,} from "../../assets/imgs";
        ...
        <div className="w-full max-w-[1440px] md:px-[80px] mx-auto px-4">
            ...
            <div className="w-full flex justify-between items-center py-3">
                ...
                <div className=" w-full flex items-center ss:w-full md:w-fit md:justify-between">
                    ...
                    {/* Weather section */}
                    <div className={`flex items-center ss:w-fit bg-bgColor px-4 h-12 border rounded cursor-pointer md:justify-center md:ml-[25px]`}>
                    ...
                    <div className="search flex items-center justify-between rounded font-medium h-12 border border-searchBgColor md:border-transparent md:w-[578px] ss:hidden md:flex">
                        ...
                        <button className="items-center bg-catalogBg pl-5 pr-7 h-12 rounded-l cursor-pointer hidden md:flex">
                            ...
                            <span className="text-fullBlue px-[9.5px] font-medium text-[15px]">Каталог</span>
                        </button>
