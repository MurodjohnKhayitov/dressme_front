...
export default function MainPageSliders() {
    ...
    return (
        <div className='box-border flex flex-col justify-center items-center	'>
            <div className="h-fit  max-w-[1440px]  md:px-[80px] flex flex-col justify-center    xs:px-[50px] ss:px-[36px] ">
                ...
                <div className="w-full h-fit ss:hidden  flex  flex-wrap gap-y-1	 justify-between   	my-5 py-7 ">
                    {
                        carosuelData?.map(data => {
                            return (
                                data.Category.map(data => {
                ...
                <div className='w-full 		my-9 py-7 '>
                ...
                <div className='flex flex-wrap justify-between items-center ss:mt-3 md:mt-12 gap-y-5 py-7 '>
                    {/* 1 */}
