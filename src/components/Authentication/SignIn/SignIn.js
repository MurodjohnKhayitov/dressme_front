  ...
  return (
    <div className=" py-8 w-full h-full flex justify-center ">
      <div className="max-w-[440px] w-[100%] h-fit  md:px-[40px] md:py-[32px] ss:p-5 border border-searchBgColor rounded-lg">
        ...
        <div className="md:hidden block mt-6 text-center"> Если у вас еще нету аккаунта</div>
        <NavLink to={'/sign_up'} className="mt-3 border md:hidden block cursor-pointer flex items-center justify-center border-searchBgColor w-full h-12 bg-OpacitySignIn select-none rounded-lg active:scale-95	active:opacity-70 ">
