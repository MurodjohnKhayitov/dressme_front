...
import { arrowBottomPayment, bucket, calendarPayment, calendatPayment, callPayment, clickLogoPayment, confirmCheckPayment, emailPayment, formArrowBottom, formArrowRightCircle, formUzFlag, kartaLogoPayment, paymeLogoPayment, profilePayment } from "../../../../assets/imgs";
        ...
        <form className="flex w-full">
          ...
          <div className="w-[35%] flex flex-col px-6 pb-8  border-t-0 border-l-0 border border-searchBgColor rounded-br-lg">  
              ...
              <div className="w-full rounded-lg h-12 flex items-center border border-searchBgColor bg-btnBgColor mb-4">
                  ...
                  <input type="number" name="paymentcard" id="paymentcard" placeholder="8600 1234 5678 9012" className="w-[58%]  bg-transparent px-4 [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" />
              </div>
              <div className="w-full flex justify-between border-b">
                <div className="w-[50%] h-12 rounded-lg flex items-center border border-searchBgColor bg-btnBgColor mb-8">
                    ...
                    <input type="number" name="paymentcard" id="paymentcard" placeholder="12/26" className="w-[34%] bg-transparent pl-2 [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" />
                </div>
