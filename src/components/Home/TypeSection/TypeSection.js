                ...
                >
                    {
                        typeSectionData?.map(data => {
                            return (
                                <div key={data?.id} className='w-[414px]  lg:h-[426px] ll:h-[400px] md:h-[390px] ss:h-[350px] bg-white border border-searchBgColor	rounded-lg ss:p-3  xl:p-[20px] flex flex-wrap ss:content-between sm:content-between  '>
