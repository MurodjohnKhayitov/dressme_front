  ...
  return (
    <main className="">
      ...
      <div className="flex flex-col px-10 py-6 w-[440px] rounded-lg border border-solid border-searchBgColor my-8 mx-auto">
        ...
        <p className="text-textColor font-AeonikProRegular mb-6">
                  ...
                  <form>
                    ...
                    <div className="flex items-center justify-between border border-solid border-searchBgColor p-4 rounded-lg bg-btnBgColor mb-4">
                      <input
                        ...
                        name="firstname"
                        id="firstname"
                        className="w-[90%] bg-btnBgColor font-AeonikProMedium text-base"
                      />
                      <button>
                    ...
                    <div className="flex items-center justify-between border border-solid border-searchBgColor p-[15px] rounded-lg bg-btnBgColor mb-4">
                      ...
                      <input
                        ...
                        placeholder="День"
                        id="day"
                        className="w-[90%] bg-btnBgColor font-AeonikProRegular text-base"
                      />
                      <input
                        type="date"
                        name="bdate"
                    ...
                    <div className="flex items-center justify-between border border-solid border-searchBgColor px-[16px] rounded-lg bg-btnBgColor mb-4">
                      <div className="flex items-center w-[45%] pr-[50px] h-full border-r py-[13px] border-r-searchBgColor">
                        ...
                        <label
                          htmlFor=""
                          className="font-AeonikProMedium text-base ml-2 mr-4 flex items-center"
                        >
                          +998
                        </label>
                      ...
                      <input
                        ...
                        className="bg-btnBgColor font-AeonikProRegular text-base ml-4 w-[178px] pr-[10px] [-moz-appearance:_textfield] [&::-webkit-outer-spin-button]:m-0 [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:m-0 [&::-webkit-inner-spin-button]:appearance-none"
                      />
                      <button>
                    ...
                    <div className="flex items-center justify-between ">
                      ...
                      <label
                        ...
                        className="mb-[6px] font-AeonikProRegular text-sm"
                      >
                        <span className={`${emailColor} font-AeonikProMedium`}>
                          *
                        </span>
                        необязательная
                      </label>
