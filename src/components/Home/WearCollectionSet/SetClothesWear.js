...
import { addBag, adidas, arrowRightCircle, checkFalse, checkTrue, Liked, model1, modelToSet, nextInfo, setHuman, setpersonIcons, star, statusFalse } from '../../../assets/imgs';
...
export default function SetClothesWear() {
    ...
    const NextArrow1 = (props) => {
        const { onClick } = props;
        return (
            <div className={`absolute right-3 top-[40%] z-10 text-center cursor-pointer no-underline  w-8 h-8 flex items-center justify-center  rounded-full bg-btnBgColor duration-200 border border-solid border-searchBgColor	`}
                onClick={onClick}>
                <GrFormNext size={15} />
            </div>
        );
    ...
    const PrevArrow1 = (props) => {
        const { onClick } = props;
        return (
            <div className={`absolute left-3 top-[40%] z-10 text-center cursor-pointer no-underline  w-8 h-8 flex items-center justify-center rounded-full bg-btnBgColor duration-200 border border-solid border-searchBgColor	`}
                onClick={onClick}>
                <GrFormPrevious size={15} />
            </div>
        );
    ...
    const NextArrowshoesWear = (props) => {
        const { onClick } = props;
        return (
            <div className={`absolute right-3 top-[25%] z-10 text-center cursor-pointer no-underline  w-8 h-8 flex items-center justify-center  rounded-full bg-btnBgColor duration-200 border border-solid border-searchBgColor	`}
                onClick={onClick}>
                <GrFormNext size={15} />
            </div>
        );
    ...
    const PrevArrowshoesWear = (props) => {
        const { onClick } = props;
        return (
            <div className={`absolute left-3 top-[25%] z-10 text-center cursor-pointer no-underline  w-8 h-8 flex items-center justify-center rounded-full bg-btnBgColor duration-200 border border-solid border-searchBgColor	`}
                onClick={onClick}>
                <GrFormPrevious size={15} />
            </div>
        );
                             ...
                             <div className='w-full  border bg-white border-searchBgColor pt-4 rounded-lg'>
                                        ...
                                        <Slider {...outWear} className={`w-full h-[160px]`}>
                                            {
                                                producListMap?.outWear.map(item => {
                                                    return (
                                                        <div key={item?.id} className={`!w-[192px] flex justify-center items-center ml-[56px] h-[148px] rounded-lg overflow-hidden border border-searchBgColor bg-btnBgColor`}>
                                                            <div className='w-full h-full'>
                                        ...
                                        <Slider {...underWear} className={`w-full h-[180px]`}>
                                            {
                                                producListMap?.underWear.map(item => {
                                                    return (
                                                        <div key={item?.id} className={`!w-[192px] flex justify-center items-center ml-[56px] h-[168px] rounded-lg overflow-hidden border border-searchBgColor bg-btnBgColor`}>
                                                            <div className='w-full h-full'>
                                        ...
                                        <Slider {...legWear} className={`w-full h-[72px]`}>
                                            {
                                                producListMap?.legWear.map(item => {
                                                    return (
                                                        <div key={item?.id} className={`!w-[192px] flex justify-center items-center  ml-[56px] h-[72px] rounded-lg overflow-hidden border border-searchBgColor bg-btnBgColor`}>
                                                            <div className='w-full h-full'>
                                        ...
                                        <Slider {...Accessory} className={`w-full h-[72px]`}>
                                            {
                                                producListMap?.Accessory.map(item => {
                                                    return (
                                                        <div key={item?.id} className={`!w-[192px] flex items-center justify-center ml-[56px] h-[72px] rounded-lg overflow-hidden border border-searchBgColor bg-btnBgColor`}>
                                                            <div className='w-full h-full'>
                                            ...
                                            {producListMap.SetToModel ? (
                                                <button
                                                    ...
                                                    <span className="w-8 h-8 flex items-center justify-center">
                                                        <img className="ml-[2px]" src={modelToSet} alt="model-to-set" />
                                                    </span>
                                                </button>
                                            ):(
                                                <button
                                ...
                                <div className='w-full pr-2 pl-4 pb-2 pt-2 flex flex-wrap content-between'>
                                    <div className='relative flex w-full justify-between items-center'>
                                        ...
                                        <button className='group absolute -top-1 right-0 rounded-lg bg-btnBgColor border border-searchBgColor flex items-center justify-center px-[11px] py-[7px] hover:bg-SignInBgColor transition ease-in duration-300'>
