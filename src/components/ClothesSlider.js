...
export default function ClothesSlider() {
    ...
    return (
        <div className='flex flex-col justify-center items-center  box-border mt-28  '>
            ...
            <div className='w-full h-fit   border-y	border-solid	border-borderColorCard mt-12'>
                <div className='h-fit md:px-[80px]  m-auto  max-w-[1440px] xs:px-[50px] ss:px-[36px]  box-border '>
                        ...
                        >
                            {
                                productList.map(data => {
                                    return (
                                        <div key={data.id} id={styles.forwidt} className="!w-[98%] ss:m-0  ll:ml-1 cursor-pointer transition ease-in-out delay-150 hover:shadow-md ss:h-[320px]  xs:h-[456px] border border-solid	borderColorCard overflow-hidden rounded-t-lg	"   >
