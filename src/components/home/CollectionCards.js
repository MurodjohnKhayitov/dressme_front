...
import SetClothesWear from "./SetClothesWear";
  ...
  return (
    <div className="flex flex-col box-border mt-[86px]">
      ...
      </div>
      {
        clothesSetWear ?
          <>
            <div className="flex justify-between flex-wrap  md:mx-0 md:mt-[50px] gap-y-3 lg:gap-y-5 ">
              {productList.map((data) => {
                return (
                  <div key={data.id} onClick={() => handleGetCardId(data?.id)} 
                  className={`w-[48.5%] border border-solid overflow-hidden rounded-lg md:w-[24%] lg:w-[240px] transition ease-in-out delay-50 hover:shadow-cardShadow ${shadowStyle} xs:h-[456px] lg:h-[440px]`}>
                    <div className="relative w-full cursor-pointer ss:h-[206px] ls:h-[220px] ll:h-[232px] xs:h-[309px] lg:h-[320px] flex content-between items-center overflow-hidden border-b border-solid flex-nowrap">
                      {data.ProducImg ? (
                      ...
                      <div className="w-full flex absolute top-px p-[5px] ss:justify-end xs:justify-between">
                        <ul className="nav-lists flex-col gap-y-1 justify-center h-full ss:hidden xs:flex">
                            <p className="group w-8 hover:w-[70px] bg-bgCard hover:bg-white  duration-300 rounded overflow-hidden border border-borderColorCard flex items-center">
                                ...
                                <span className=" w-0 flex items-center -mr-[1px] group-hover:w-10 duration-300  text-red-700 not-italic  font-AeonikProMedium text-[11px] mt-1">
                                -30%
                                </span>
                            </p>
                            <p className="group w-8 hover:w-[70px] bg-bgCard hover:bg-white  duration-300 rounded overflow-hidden border border-borderColorCard flex items-center">
                                ...
                                <span className=" w-0 flex items-center -mr-[1px] group-hover:w-10 duration-300 not-italic  font-AeonikProRegular text-[11px] mt-1">
                                Video
                                </span>
                            </p>
                            <p className="group w-8 hover:w-[85px] bg-bgCard hover:bg-white  duration-300 rounded overflow-hidden border border-borderColorCard flex items-center">
                                ...
                                <span className=" w-0 flex items-center  group-hover:w-[40px] duration-300 not-italic  font-AeonikProRegular text-[11px] mt-1">
                                Delivery
                                </span>
                            </p>
                        </ul>
                    ...
                    <div className="w-full rounded-b-1xl bg-white  flex flex-wrap content-between px-1 xs:py-3 lg:p-3 ss:h-[124px] xs:h-[147px] lg:h-[120px] ss:py-2 xs:px-2">
                        ...
                        <div className="w-full flex justify-between items-center xs:mt-3">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="not-italic font-AeonikProRegular text-[10px] ls:text-xs leading-4 text-right text-gray-500 ml-[2px] md:ml-1 flex items-center">
                              <span className="font-AeonikProMedium text-[10px] ls:text-xs not-italic mx-1 text-black md:text-[13px]">
                                5.0{" "}
                              </span>
                              ({data?.starCount || 0}{" "}
                              <span className="ss:hidden lg:block md:text-[11px] font-AeonikProRegular ml-1">
                                голосов
                              </span>
                              )
                            </span>
                          </div>
                          <div className="not-italic font-AeonikProRegular  leading-4 text-black ss:text-[11px] ls:text-[14px]">
                            <b>
                        ...
                        <div>
                          {data.sale ? (
                            <div className="flex ss:flex-col-reverse md:flex-row	text-start items-start ">
                              <div className="text-start m-0 p-0  not-italic font-AeonikProMedium text-sm ls:text-base leading-1 text-red-700 xs:text-base xs:leading-4 mr-1">
                                {data?.sale}
                              </div>
                              <div className="text-start m-0 p-0 text-[11px] ls:text-[12px] mt-[4px]  line-through not-italic font-AeonikProRegular leading-3  text-borderColorCard ss:leading-1 md:text-[11px]">
                                {data?.price}
                              </div>
                            </div>
                          ) : (
