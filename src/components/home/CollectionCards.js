    ...
    <div className="flex flex-col box-border mt-[86px]">
        ...
        <div className="w-full ss:block sm:flex justify-between items-center mb-[25px] md:mb-0 md:px-0">
            ...
            <div className="rounded  h-[42px] md:h-[52px] ss:w-full md:w-[308px] md:mx-0 flex justify-between bg-slate-50 border border-solid ss:mt-5 md:mt-0 mx-auto ">
                <button className={`ss:w-1/2 md:w-[152px] md:h-[50px]  h-[42px] text-base text-black text-center font-normal not-italic focus:bg-white focus:border focus:border-solid	focus:border-inheri focus:rounded ${dataStyle}`}>
                    {" "}
                    Одежда
                </button>
                <button className={`ss:w-1/2 md:w-[152px] md:h-[50px]  h-[42px] text-base text-black text-center font-normal not-italic focus:bg-white focus:border focus:border-solid	focus:border-inheri focus:rounded ${dataStyle}`}>
        ...
        <div className="flex justify-between flex-wrap  md:mx-0 md:mt-[50px] gap-y-5 lg:gap-y-5 ">
            {productList.map((data) => {
                return (
                    <div key={data.id} className={` ss:w-[48%] md:w-[24%] lg:w-[240px] transition ease-in-out delay-50 hover:shadow-lg ${shadowStyle} xs:h-[456px] lg:h-[440px] border border-solid borderColorCard overflow-hidden rounded-lg`} >
